...
class LogisticRegressionComparison:
    """Framework for comparing Logistic Regression with MoE model"""
    ...
    def train_logistic_regression(self, output_dir):
        """
        ...
        # Save results
        self._save_model_results('Logistic_Regression', metrics, output_dir)
        
        # Generate and save confusion matrix
        self._plot_confusion_matrix(self.y_test, y_pred, 'Logistic_Regression', output_dir)
        
        # Save feature importance analysis
        self._analyze_feature_importance(model, output_dir)
    ...
    def _analyze_feature_importance(self, model, output_dir):
        """
        Analyze and visualize feature importance from logistic regression coefficients
        """
...
def main():
    ...
    comparison = LogisticRegressionComparison(data_path, all_features)
    
    # Train and evaluate Logistic Regression
    print("\nStarting Logistic Regression training and evaluation...")
    lr_results = comparison.train_logistic_regression(output_dir)
