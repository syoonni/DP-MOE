...
class ExpertOrderOptimizer:
    def __init__(self, data_path, device, base_expert_features, base_dir, labels=['CN', 'MCI'], 
...
def main():
    ...
    # Set base directory
    base_dir = '/root/Project/ClassifyProject/MOE/results/search2_cnvsmci'
    ...
    base_expert_features = {
        'expert_1': ['28', 'manu_37', 'Sum', '13', '29', '14', '40'],
